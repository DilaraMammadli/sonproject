          ...
          <SwiperSlide>
            <div className="bigswiper__sec">
              ...
              <div className="swipertext__sec">
                ...
                <p>Buying an upholstered suite is one of the most important investments you can make for your home. In the living room, it's a piece for lounging, reading, eating, entertaining, watching TV, and even sleeping, so it makes sense that we invest in one that will last for years to come.</p>
                <button>Read more</button>
